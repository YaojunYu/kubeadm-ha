...
etcd:
  local:
    extraArgs:
      listen-client-urls: "https://127.0.0.1:2379,https://10.142.0.2:2379"
      ...
      initial-cluster: "k8s-m1=https://10.128.0.2:2380,k8s-m2=https://10.128.0.3:2380,k8s-m3=https://10.142.0.2.:2380"
